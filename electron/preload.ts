...
import {IPC_ACTION} from "./IPC/IPCActions";
...
contextBridge.exposeInMainWorld("ipcAPI", {
	setWindowTitle: (title: string) => ipcRenderer.invoke(IPC_ACTION.Window.SET_WINDOW_TITLE, title),
	getNewGames: () => ipcRenderer.invoke(IPC_ACTION.Game.GET_NEW_GAMES),
});